...
<head>
    ...
    <title>Mobile | Cyber-Deals</title>
...
<body class="full-page">
    ...
    <div class="main-content">
        <h1 class="page-title">MOBILE <span style="color:#ffd700">COLLECTION</span></h1>        
    ...
    <div id="loginModal" class="modal">
        <div class="modal-content">
            ...
            <form id="customerLoginForm" class="login-form" action="../../login.php" method="post">
                ...
                <input type="hidden" name="redirect_to" value="customer/shop/mobile.php">
