...
<head>
    ...
    <title>Processing Team Dashboard - Cyber-Deals</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="css/processing_styles.css" rel="stylesheet">
</head>
<body>
    <div class="sidebar">
    <a href="add_product.php" class="btn btn-product" target="_blank">Add Product</i></a>
        ...
        <a href="view_feedbacks.php" class="btn btn-feedback" target="_blank">View Feedbacks</a>
        <a href="delete_feedback.php" class="btn btn-feedback" target="_blank">Delete Feedbacks</a>
        ...
        <div class="container" id="content">
            ...
            <div class="video-container">
                <video autoplay muted loop>
                    <source src="video/graph06.mp4" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
